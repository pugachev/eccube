...
<form name="form1" id="form1" method="post" action="?" autocomplete="off"  enctype="multipart/form-data">
    ...
    <input type="hidden" name="image_key" value="main_image" />
    <!--{foreach key=key item=item from=$arrForm.arrHidden}-->
        <input type="hidden" name="<!--{$key}-->" value="<!--{$item|h}-->" />
    <!--{/foreach}-->
    <!--{foreach key=key item=item from=$arrForm.arrFile}-->
        <input type="hidden" name="<!--{$key}-->" value="<!--{$item|h}-->" />
    <!--{/foreach}-->
    <!-- 検索条件の保持 -->
    <!--{foreach from=$arrSearchData key="key" item="item"}-->
    ...
    <div id="customer" class="contents-main">
        <table class="form">
            ...
            <tr>
                ...
                <td>
                    <span class="attention"><!--{$arrErr.dm_id}--></span>
                    <span <!--{if $arrErr.dm_id != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="dm_id" options=$arrDm separator="&nbsp;" selected=$arrForm.dm_id}-->
                    </span>
                </td>
            </tr>
            <tr>
                <th>趣味</th>
                <td>
                <span class="attention"><!--{$arrErr.hobby_id}--></span>
                <!--{html_checkboxes name="hobby_id" options=$arrHobby selected=$arrForm.hobby_id separator='&nbsp;&nbsp;'}-->
                </td>
            </tr>
            <tr>
                <th>美人度<span class="attention"> *</span></th>
                <td>
                    <span class="attention"><!--{$arrErr.bijin_id}--></span>
                    <span <!--{if $arrErr.dm_id != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="bijin_id" options=$arrBijin separator="&nbsp;" selected=$arrForm.bijin_id}-->
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <span class="attention"><!--{$arrErr.married_id}--></span>
                    <span <!--{if $arrErr.dm_id != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
            ...
            <tr>
                ...
                <th>会員様画像<br />[<!--{$smarty.const.NORMAL_IMAGE_WIDTH}-->×<!--{$smarty.const.NORMAL_IMAGE_HEIGHT}-->]</th>
                <td>
