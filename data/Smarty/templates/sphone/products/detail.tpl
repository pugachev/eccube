            ...
            <div id="detailrightblock">
                ...
                <!--{if $arrProduct.maker_code|strlen >= 1}-->
                    <dl class="relative_cat">
                        <dt>メーカーコード：</dt>
                        <dd><!--{$arrProduct.maker_code|h}--></dd>
                    </dl>
                <!--{/if}-->
                <!--{* ▲メーカーコード *}-->

                <!--{* ▼配送種別 *}-->
                <!--{if $arrProduct.delivery_type_id|strlen >= 1}-->
                    <dl class="relative_cat">
                        <dt>配送種別：</dt>
                        <dd><!--{$arrDeliveryType[$arrProduct.delivery_type_id]|h}--></dd>
                    </dl>
                <!--{/if}-->
                <!--{* ▲配送種別 *}-->

                <!--{* ▼保証期間 *}-->
                <!--{if $arrProduct.warranty_period_id|strlen >= 1}-->
                    <dl class="relative_cat">
                        <dt>保証期間：</dt>
                        <dd><!--{$arrWarrantyPeriod[$arrProduct.warranty_period_id]|h}--></dd>
                    </dl>
                <!--{/if}-->
                <!--{* ▲配送種別 *}-->

                <!--▼ギフト対応-->
                <!--{assign var=gift value=$gifts[$tpl_product_id]}-->
                <!--{if count($gift) > 0}-->
                    <dl class="relative_cat">
                        <dt>ギフト対応：</dt>
                        <!--{foreach from=$gift item=val}-->
                        <dd><!--{$arrGift[$val]|h}--></dd>
                        <!--{/foreach}-->
                    </dl>
                <!--{/if}-->
